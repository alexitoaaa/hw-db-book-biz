 ...
 * Author: Alexander Adelabu
 * Course: 1.125 Archictecturing Software Systems
*/

drop database if exists books_industry;
create database if not exists books_industry;
use books_industry;
